...
namespace ppm {
    ...
    public:
        ...
        void set_pixel( const int x, const int y, in_<Color> color )
        {
            m_pixels( x, y ) = color;
        }
        ...
        {
            set_pixel( x, y, m_drawing_color );
        }

        void draw_horizontal_at( const int y, const int x1, const int x2, in_<Color> color )
        {
            if( x1 > x2 ) {
        ...
        void draw_horizontal_at( const int y, const int x1, const int x2 )
        {
            draw_horizontal_at( y, x1, x2, m_drawing_color );
        }

        void draw_vertical_at( const int x, const int y1, const int y2, in_<Color> color )
        {
            if( y1 > y2 ) {
        ...
        void draw_vertical_at( const int x, const int y1, const int y2 )
        {
            draw_vertical_at( x, y1, y2, m_drawing_color );
        }
